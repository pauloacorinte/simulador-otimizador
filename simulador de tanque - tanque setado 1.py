        ...
        while OP[i] != "FIM":
            ...
            if OP[i] == "DESLOCANDO":
                ...
                if z[i] < zi:
                    ...
                    w.append(-omega)
                    STATUS.append("YAW-")
                elif (x[i] < xi or y[i] < yi) and v[i-1] < v_desloc:
                    vz.append(0.0)
        ...
        #============================================================================================#        
            if OP[i] == "PULVERIZANDO":
                ...
                if z[i] >= z_pulverizando:
                    ...
                    w.append(0.0)
                    STATUS.append("SUBIDA")
                elif ((theta[i] == theta_dir and y[i] < yi + Y and v[i-1] < v_pulv) or (theta[i] == theta_dir + 180 and y[i] > yi and v[i-1] < v_pulv)):
                    vz.append(0.0)
                    v.append(v[i-1]+dt*acel)
                    w.append(0.0)
                    STATUS.append("PITCH")
                    ...
                    w.append(0.0)
                    STATUS.append("PITCH")
                elif(theta[i] >= theta_dir and y[i] >= (yi + Y) and v[i-1] > math.pi/180*omega*faixa/2):
                    vz.append(0.0)
                    w.append(0.0)
                    v.append(v[i-1]-dt*acel)
                    STATUS.append("PITCH")
                    ...
                    STATUS.append("YAW+")
                elif(theta[i] <= theta_dir + 180 and y[i] <= yi and v[i-1] > math.pi/180*omega*faixa/2):
                    vz.append(0.0)
                    w.append(0.0)
                    v.append(v[i-1]-dt*acel)
                    STATUS.append("PITCH")
            ...
            if OP[i] == "RTW":
                ...
                if theta_rtl == theta_dir:
                    if z[i] < z_rtl:
                         ...
                         w.append(-omega)
                         STATUS.append("YAW-")
                    elif (x[i] < x_rtl or y[i] < y_rtl) and v[i-1] < v_desloc:
                         vz.append(0.0)
                         v.append((v[i-1]+dt*acel))
                         w.append(0.0)
                         STATUS.append("PITCH")
                         ...
                         w.append(0.0)
                         STATUS.append("PITCH")
                    elif theta[i] > theta_rtl and v[i-1] <= 0 and (x[i]**2 + y[i]**2)**(1/2) <= (x_rtl**2+y_rtl**2)**(1/2):
                         print("AAA")
                         x[i] = x_rtl
                         y[i] = y_rtl
                         vz.append(0.0)
                         ...
                         w.append(-omega)
                         STATUS.append("YAW-2")
                    elif theta[i] > theta_rtl and (x[i]**2 + y[i]**2)**(1/2) >= ((x_rtl**2+y_rtl**2)**(1/2)-(v_desloc**2/(2*acel))) and v[i-1] > 1:
                         if v[i-1] <= 0:
                             v.append(0)
                             x[i] = x_rtl
                             y[i] = y_rtl
                    ...
                    # elif theta[i] > theta_rtl and v[i-1] <= 0:
                    #      print("AAA")
                    #      x[i] = x_rtl
                    #      y[i] = y_rtl
                    #      vz.append(0.0)
